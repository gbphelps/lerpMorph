...
const xLims = limits(moved, 'x');
const yLims = limits(moved, 'y');
...
ll.set({
  y1: corners[0].y, y2: corners[1].y, x1: corners[0].x, x2: corners[1].x, stroke: 'red',
});
ll.append();

const lr = new Element('line');
lr.set({
  y1: corners[1].y, y2: corners[3].y, x1: corners[1].x, x2: corners[3].x, stroke: 'red',
});
lr.append();

const lt = new Element('line');
lt.set({
  y1: corners[2].y, y2: corners[3].y, x1: corners[2].x, x2: corners[3].x, stroke: 'red',
});
lt.append();

const lb = new Element('line');
lb.set({
  y1: corners[2].y, y2: corners[0].y, x1: corners[2].x, x2: corners[0].x, stroke: 'red',
});
lb.append();
