import { QuadNums, functionIn2D } from '../types';
...
export function curveWithOffset(c: QuadNums, t0: number) {
...
export function derivativeWithOffset(c: QuadNums, t0: number) {
...
export function curve(c: QuadNums): functionIn2D {
  return curveWithOffset(c, 0);
}

export function derivative(c: QuadNums): functionIn2D {
